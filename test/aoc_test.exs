defmodule AocTest do
  ...
  test :day_03 do
    ...
    gamma_rate = Report.gamma_rate(report)
    epsilon_rate = Report.epsilon_rate(report)

    assert gamma_rate * epsilon_rate == 3_549_854
  end
  ...
  test :day_03_part_2 do
    ...
    oxygen_generator_rating = Report.oxygen_generator_rating(report)
